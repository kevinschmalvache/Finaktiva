...
namespace sb_admin_2.Web.Domain
{
    public class Data
    {
        public IEnumerable<Navbar> navbarItems()
        {
            ...
            menu.Add(new Navbar { Id = 1, nameOption = "Municipios", controller = "Municipios", action = "Index", imageClass = "fa fa-database fa-fw", status = true, isParent = false, parentId = 0 });
            menu.Add(new Navbar { Id = 2, nameOption = "Regiones", controller = "Regiones", action = "Index", imageClass = "fa fa-book fa-fw", status = true, isParent = false, parentId = 0 });

            //menu.Add(new Navbar { Id = 4, nameOption = "Región", imageClass = "fa fa-bar-chart-o fa-fw", status = true, isParent = true, parentId = 0 });
            //menu.Add(new Navbar { Id = 5, nameOption = "Región Hijo 1", controller = "Home", action = "FlotCharts", status = true, isParent = false, parentId = 4 });
            //menu.Add(new Navbar { Id = 6, nameOption = "Región Hijo 2", controller = "Home", action = "MorrisCharts", status = true, isParent = false, parentId = 4 });
